            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                    <h6 class="text-white text-capitalize ps-3">
                        <spring:message code="locationHistory.title"/>
                    </h6>
                </div>
            </div>
            <div class="card-body px-0 pb-2">
                <!-- Search Form -->
                <form action="<c:url value='/location-histories' />" method="get" class="mx-4">
                    <div class="row">
                ...
                <!-- Bulk Action Form -->
                <form id="bulkActionForm" action="<c:url value='/location-histories/bulk-action' />" method="post">
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-3">
                                    <a href="<c:url value='/location-histories?sort=id&direction=${param.direction eq \'asc\' ? \'desc\' : \'asc\'}' />">
                                        <spring:message code="id"/>
                                        <i class="material-icons">${param.sort eq 'id' && param.direction eq 'asc' ? 'arrow_upward' : 'arrow_downward'}</i>
                                    </a>
                                </th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-3">
                                    <a href="<c:url value='/location-histories?sort=device&direction=${param.direction eq \'asc\' ? \'desc\' : \'asc\'}' />">
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-3">
                                    <a href="<c:url value='/location-histories?sort=location&direction=${param.direction eq \'asc\' ? \'desc\' : \'asc\'}' />">
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-3">
                                    <a href="<c:url value='/location-histories?sort=locationDetail&direction=${param.direction eq \'asc\' ? \'desc\' : \'asc\'}' />">
                                        <spring:message code="locationDetail"/>
                                        <i class="material-icons">${param.sort eq 'locationDetail' && param.direction eq 'asc' ? 'arrow_upward' : 'arrow_downward'}</i>
                                    </a>
                                </th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-3">
                                    <a href="<c:url value='/location-histories?sort=dateOfMoving&direction=${param.direction eq \'asc\' ? \'desc\' : \'asc\'}' />">
                                        <spring:message code="locationHistory.dateOfMoving"/>
                                        <i class="material-icons">${param.sort eq 'dateOfMoving' && param.direction eq 'asc' ? 'arrow_upward' : 'arrow_downward'}</i>
                                    </a>
                                </th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-3">
                                    <a href="<c:url value='/location-histories?sort=note&direction=${param.direction eq \'asc\' ? \'desc\' : \'asc\'}' />">
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
                                    <a href="<c:url value='/location-histories?sort=createdAt&direction=${param.direction eq \'asc\' ? \'desc\' : \'asc\'}' />">
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
                                    <a href="<c:url value='/location-histories?sort=updatedAt&direction=${param.direction eq \'asc\' ? \'desc\' : \'asc\'}' />">
                            ...
                            <tbody>
                            <c:forEach items="${locationHistories}" var="locationHistory">
                                <tr>
                                    <td class="ps-3">
                                        <input type="checkbox" name="selectedIds" value="${locationHistory.id}"
                                               class="selectItem">
                                    </td>
                                    <td class="ps-3">
                                        <p class="text-xs font-weight-bold mb-0">${locationHistory.id}</p>
                                    </td>
                                    <td class="ps-3">
                                        <p class="text-xs font-weight-bold mb-0">${locationHistory.device.id}</p>
                                    </td>
                                    <td class="ps-3">
                                        <p class="text-xs font-weight-bold mb-0">${locationHistory.location.building}</p>
                                    </td>
                                    <td class="ps-3">
                                        <p class="text-xs font-weight-bold mb-0">${locationHistory.locationDetail.room}</p>
                                    </td>
                                    <td class="ps-3">
                                        <p class="text-xs font-weight-bold mb-0">${locationHistory.dateOfMoving}</p>
                                    </td>
                                    <td class="ps-3">
                                        <p class="text-xs font-weight-bold mb-0">${locationHistory.note}</p>
                                    </td>
                                    <td>
                                        <p class="text-xs font-weight-bold mb-0">${locationHistory.createdAt}</p>
                                    </td>
                                    <td>
                                        <p class="text-xs font-weight-bold mb-0">${locationHistory.updatedAt}</p>
                                    </td>
                                    <td class="align-middle">
                                        <a href="<c:url value='/location-histories/${locationHistory.id}/delete' />"
