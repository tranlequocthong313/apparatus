	...
	<div class="col-12">
		<div class="card my-4">
			...
			<div class="card-body px-0 pb-2">
				<!-- Search Form -->
				<form action="<c:url value='/users' />" method="get" class="mx-4">
					<div class="row">
						...
						<div class="col-md-2 mb-3">
							<div class="input-group input-group-outline">
								<select name="userRole" id="userRole" class="form-control">
									<option value=""><spring:message code="all.user.role"/></option>
									<c:forEach items="${userRoles}" var="r">
										<option value="${r}" ${userRole == r ? 'selected' : ''}>
											<spring:message code="role.${r.toLowerCase()}"/>
										</option>
									</c:forEach>
								</select>
							</div>
				...
				<!-- Bulk Action Form -->
				<form id="bulkActionForm" action="<c:url value='/users/bulk-action' />" method="post">
					...
					<div class="table-responsive p-0">
						<table class="table align-items-center mb-0">
							...
							<tr>
								...
								<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-3">
									<a href="<c:url value='/users?sort=id&direction=${param.direction eq \'asc\' ? \'desc\' : \'asc\'}' />">
										<spring:message code="id"/>
										<i class="material-icons">${param.sort eq 'id' && param.direction eq 'asc' ? 'arrow_upward' : 'arrow_downward'}</i>
									</a>
								</th>
								<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-3">
									<a href="<c:url value='/users?sort=fullName&direction=${param.direction eq \'asc\' ? \'desc\' : \'asc\'}' />">
										<spring:message code="user.fullName"/>
										<i class="material-icons">${param.sort eq 'fullName' && param.direction eq 'asc' ? 'arrow_upward' : 'arrow_downward'}</i>
									</a>
								</th>
								<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-3">
									<a href="<c:url value='/users?sort=email&direction=${param.direction eq \'asc\' ? \'desc\' : \'asc\'}' />">
										<spring:message code="user.email"/>
										<i class="material-icons">${param.sort eq 'email' && param.direction eq 'asc' ? 'arrow_upward' : 'arrow_downward'}</i>
									</a>
								</th>
								<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-3">
									<a href="<c:url value='/users?sort=phoneNumber&direction=${param.direction eq \'asc\' ? \'desc\' : \'asc\'}' />">
										<spring:message code="user.phoneNumber"/>
										<i class="material-icons">${param.sort eq 'phoneNumber' && param.direction eq 'asc' ? 'arrow_upward' : 'arrow_downward'}</i>
									</a>
								</th>
								<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-3">
									<a href="<c:url value='/users?sort=username&direction=${param.direction eq \'asc\' ? \'desc\' : \'asc\'}' />">
										<spring:message code="user.username"/>
										<i class="material-icons">${param.sort eq 'username' && param.direction eq 'asc' ? 'arrow_upward' : 'arrow_downward'}</i>
									</a>
								</th>
								<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-3">
									<a href="<c:url value='/users?sort=active&direction=${param.direction eq \'asc\' ? \'desc\' : \'asc\'}' />">
										<spring:message code="user.active"/>
										<i class="material-icons">${param.sort eq 'active' && param.direction eq 'asc' ? 'arrow_upward' : 'arrow_downward'}</i>
									</a>
								</th>
								<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-3">
									<a href="<c:url value='/users?sort=userRole&direction=${param.direction eq \'asc\' ? \'desc\' : \'asc\'}' />">
										<spring:message code="user.userRole"/>
										<i class="material-icons">${param.sort eq 'userRole' && param.direction eq 'asc' ? 'arrow_upward' : 'arrow_downward'}</i>
									</a>
								</th>
								<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
									<a href="<c:url value='/users?sort=note&direction=${param.direction eq \'asc\' ? \'desc\' : \'asc\'}' />">
										<spring:message code="note"/>
										<i class="material-icons">${param.sort eq 'note' && param.direction eq 'asc' ? 'arrow_upward' : 'arrow_downward'}</i>
									</a>
								</th>
								<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
									<a href="<c:url value='/users?sort=createdAt&direction=${param.direction eq \'asc\' ? \'desc\' : \'asc\'}' />">
								...
								<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
									<a href="<c:url value='/users?sort=updatedAt&direction=${param.direction eq \'asc\' ? \'desc\' : \'asc\'}' />">
							...
							<c:forEach items="${users}" var="user">
								<tr>
									...
									<td>
										<p class="text-xs font-weight-bold mb-0">${user.active}</p>
									</td>
									<td>
										<p class="text-xs font-weight-bold mb-0">${user.userRole}</p>
									</td>
									<td>
										<p class="text-xs font-weight-bold mb-0">${user.note}</p>
									</td>
									<td>
										<p class="text-xs font-weight-bold mb-0">${user.createdAt}</p>
									</td>
									<td>
										<p class="text-xs font-weight-bold mb-0">${user.updatedAt}</p>
									</td>
